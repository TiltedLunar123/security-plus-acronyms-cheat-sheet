# CompTIA Security+ SY0-701 Acronyms Cheat Sheet

A free, complete cheat sheet of **every acronym in the CompTIA Security+ (SY0-701) exam objectives**, expanded and grouped by topic. No signup, no email. Print it, pin it, and check off the ones you know cold.
...
- **Free Security+ practice questions** (with answers and explanations): [secplusmastery.com/security-plus-practice-questions](https://secplusmastery.com/security-plus-practice-questions)
- **Full SY0-701 course** (lessons, mock exams, spaced review): [secplusmastery.com](https://secplusmastery.com)
...
| `PAM (modules)` | Pluggable Authentication Modules |
| `PAP` | Password Authentication Protocol |
| `PIV` | Personal Identity Verification |
| `RBAC` | Role-Based Access Control |
| `RBAC (rule)` | Rule-Based Access Control |
...
Maintained by [SecPlus Mastery](https://secplusmastery.com), a mastery-based study platform for the CompTIA Security+ SY0-701 exam.
